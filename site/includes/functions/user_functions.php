...
function userHoursAnnualRequirementsQueryArr($b = 'seasons', $l = 'annual_requirements', $c = 'off_season_hours', $d = 'on_season_hours') {
	...
	if($d != false) {
		$sel .= ', IFNULL('.$d.'.season_hours,0) AS season_hours, IFNULL('.$d.'1.season_hours,0) AS season_hours_exempt, IFNULL('.$d.'.season_hours_exempt >= '.$b.'.hour_requirement,0) AS min_hours';
