...
SUM(time_to_sec(timediff(a.time_out, a.time_in)) / 3600) as sum, year(a.time_in) as year from meeting_hours a WHERE year(a.time_in) BETWEEN '.$start_date.' AND '.$end_date.' LEFT JOIN users b USING (user_id) GROUP BY year,student_grade';
