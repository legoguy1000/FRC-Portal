  ...
  public function getBuildSeasonHoursAttribute() {
    ...
    return DB::table('meeting_hours')
            ...
            ->leftJoin('seasons', function ($join) {
              ...
              ->whereRaw('seasons.season_id = :season_id', array('season_id' => $this->attributes['season_id']))
              ->whereRaw('meeting_hours.user_id = :user_id', array('user_id' => $this->attributes['user_id']))
