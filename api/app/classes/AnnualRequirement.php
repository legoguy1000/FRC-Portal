  ...
  public function bsh() {
    //if(isset($this->attributes['user_id']) && isset($this->attributes['season_id'])) {
      ...
      return $this->hasOne('FrcPortal\Season', 'season_id', 'season_id')
                  ...
                  ->select(DB::raw('SUM(time_to_sec(IFNULL(timediff(meeting_hours.time_out, meeting_hours.time_in),0)) / 3600) as build_season_hours'))->groupBy('seasons.year','meeting_hours.user_id');
  //  }
  }
