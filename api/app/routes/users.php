...
$app->group('/users', function () {
  $this->get('', function ($request, $response, $args) {
    ...
    $queryArr = array();
      ...
      $users = FrcPortal\User::leftJoin('schools', 'users.school_id', '=', 'schools.school_id')->select(FrcPortal\User::newQuery(), 'schools.school_name', 'schools.abv')->havingRaw($queryStr)->get();
