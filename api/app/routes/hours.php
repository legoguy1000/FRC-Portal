    ...
    $this->post('/authorize', function ($request, $response, $args) {
      ...
      if(isset($args['auth_token'])) {
        ...
        try {
          ...
          $responseArr = unauthorizedResponse($response, $status = false, $msg = 'Authorization Error. '.$e->getMessage(), $data = null);
    ...
    $this->post('', function ($request, $response, $args) {
      ...
      if(isset($args['token'])) {
        ...
        try{
          ...
          return unauthorizedResponse($response, $status = false, $msg = 'Authorization Error. '.$e->getMessage().'.  Please see Mentor.', $data = null);
        } catch(\Firebase\JWT\SignatureInvalidException $e){
          return unauthorizedResponse($response, $status = false, $msg = 'Authorization Error. '.$e->getMessage().'.  Please see Mentor.', $data = null);
        }
      } else {
